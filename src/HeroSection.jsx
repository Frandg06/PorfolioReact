  ...
  return (
    <section className="flex flex-col sm:items-center gap-4 border-b border-gray-500 border-dotted sm:flex-row pb-14">
      <div className="flex items-center gap-2">
        ...
        <h1 className="text-2xl font-mono text-center text-primary sm:text-4xl sm:hidden">
          {user.short_name}
        </h1>
      </div>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex gap-4 text-md">
          <div
            className="tooltip size-10"
            data-tip="Abierto a nuevas oportunidades"
          >
          ...
          >
            <Icon
              ...
              className="mx-auto size-5 text-white/80"
            />
            Currículum
          </a>
        </div>
