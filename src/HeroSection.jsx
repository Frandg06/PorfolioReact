  ...
  return (
    <section className="flex flex-col items-center gap-4 border-b border-gray-500 border-dotted sm:flex-row pb-14">
      ...
      <div className="flex flex-col gap-4">
        <div>
          <h1 className="text-2xl font-bold text-center text-white sm:text-4xl sm:text-start">
            {user.name}
          </h1>
          <p className="my-3 text-md sm:text-md text-white/70 sm:text-balance">
            {user.hero_desc1}
          </p>
          <p className="text-md sm:text-md text-white/70 sm:text-balance">
            {user.hero_desc2}
          </p>
        </div>
        <div className="flex gap-4 text-md">
          <button
            className="p-2 rounded-lg bg-emerald-500 block w-[40px] hover:bg-emerald-700 hover:-translate-y-1 duration-500"
            data-tooltip-target="abierto-a-trabajar"
          >
            <Icon
              icon="gravity-ui:target-dart"
              className="mx-auto text-white size-5"
            />
          </button>
          <button
          ...
          >
            <Icon
              ...
              className="mx-auto size-5 text-white/70"
            />
            Curriculum
          </button>
        </div>
