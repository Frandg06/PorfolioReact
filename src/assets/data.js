export const data = {
  ...
  hero_desc1:
    '4 años de experiencia. <span className="text-highlighted">Técnico en desarrollo de aplicaciones web y en administración de sistemas</span>. León, España 🇪🇸. Especializado en el desarrollo de aplicaciones web únicas.',

  experience: [
    {
      title: "SDi",
      label: "Actualmente",
      date: "Desde Enero de 2025",
      desc: [
        "En SDi, mi objetivo ha sido ir más allá de simplemente 'sacar el trabajo': me he centrado en modernizar cómo construimos el software. Me encontré con unos backends que necesitaban escalar, así que reestructuré la arquitectura moviendo la lógica compleja hacia Actions y Pipelines. Al aplicar principios SOLID, conseguimos un código mucho más limpio y fácil de mantener a largo plazo",
        "También me obsesiona el rendimiento. Usando Laravel Telescope, pude identificar y resolver cuellos de botella críticos (especialmente los famosos problemas de consultas N+1), logrando que nuestras APIs respondieran en la mitad de tiempo (-50% latencia).",
        "Para mejorar el día a día del equipo , introduje herramientas modernas: testing con Pest, análisis de código automático con Rector y Pint, y documentación que se genera sola gracias a Scramble. Además, integré Laravel Boost para que la IA nos ayude a programar con el contexto real del proyecto. Todo esto nos permite hacer despliegues a producción frecuentes, seguros y sin estrés.",
      ],
    },
    {
      title: "ITGallery",
      label: null,
      date: "Desde Junio de 2023 hasta Enero de 2025",
      desc: [
    ...
    },
    {
      ...
      label: null,
      date: "Desde Junio de 2022 hasta Enero de 2023",
      desc: [
    ...
    },
    {
      ...
      label: null,
      date: "Desde marzo de 2022 hasta junio de 2022",
      desc: [
  ...
  formation: [
    {
      ...
      date: "Septiembre de 2020 a julio de 2022",
      desc: [
