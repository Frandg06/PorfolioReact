    ...
    <article className="grid gap-8 md:grid-cols-2 mt-14">
      {user.projects.map((item, index) => (
        <a
          ...
          className="relative flex items-center p-4 duration-300 border-2 h-36 border-white/30 rounded-2xl group/project2 hover:border-white/70 hover:-translate-y-2"
        >
          <div>
            <h1 className="block p-0 m-0 text-xl font-bold text-white">
              {item.title}
            </h1>
